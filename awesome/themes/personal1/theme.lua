...
theme.wallpaper                                 = "~/wallpaper/rusy-crab.png"
theme.font                                      = "Poppins-Thin 8"
theme.fg_normal                                 = "#ebebeb"
theme.fg_focus                                  = "#ebebeb"
theme.bg_normal                                 = "#343530"
theme.bg_focus                                  = "#343530"
...
local localdate = wibox.widget.textclock(markup("#FFFFFF", "%A, %d %B"))
localdate.font = theme.font
...
theme.fs = lain.widget.fs({
    notification_preset = { fg = white, bg = theme.bg_normal, font = "Terminus 67.5" },
    settings  = function()
...
-- Separators
local first = wibox.widget.textbox(markup.font("Poppins-Thin 8", " "))
local tab = wibox.widget.textbox('  ')
local spr   = wibox.widget.textbox(' ')
local bar_spr = wibox.widget.textbox(markup.font("Poppins-Thin 8", "|"))
...
function theme.at_screen_connect(s)
  ...
  -- Create the wibox
  s.mywibox = awful.wibar({ position = "bottom", screen = s, height = dpi(14), bg = theme.bg_normal, fg = theme.fg_normal})
